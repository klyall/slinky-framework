package org.slinkyframework.service.test.metrics;
...
public class AbstractServiceMetricsAspectTest {
    ...
    public void shouldRecordMetricsForNormalExecution() throws UnknownHostException {
        ...
        assertThat("Metric class tag", timer.getId().getTag("class"), is("ExampleService"));
